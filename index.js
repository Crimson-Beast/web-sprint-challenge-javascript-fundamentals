...
//the nested function, the variable for 'internal' and 
//the ability to call the function are well within the 
//scope of the function, myFucntion(). nestedFunction() is 
//just another result that myFucntion() produces
...
CuboidMaker.prototype.volume = function volume(length, width, height){
...
CuboidMaker.prototype.surfaceArea = function surfaceArea(length, width, height){
...
//   height: 5
// }
// const cuboid = new CuboidMaker(obj)
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
// console.log(cuboid.volume(obj)); // 100
// console.log(cuboid.surfaceArea(obj)); // 130
